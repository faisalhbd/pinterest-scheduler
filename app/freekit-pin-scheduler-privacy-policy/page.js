export const metadata = {
  title: "Privacy Policy — Pin Scheduler by Freekit",
}

export default function Privacy() {
  return (
    <main style={{ maxWidth: 640, margin: "40px auto", fontFamily: "system-ui, sans-serif", padding: "0 16px", lineHeight: 1.6 }}>
      <h1>Privacy Policy — Pin Scheduler (Freekit)</h1>
      <p>Last updated: July 2026</p>
      <p>
        Pin Scheduler, a tool by Freekit (freekit.online), connects to your Pinterest account
        using Pinterest's official OAuth 2.0 flow. We never ask for or store your Pinterest password.
      </p>
      ...
      <h2>Contact</h2>
      <p>
        For questions about this policy, contact the Freekit team at{" "}
        <a href="mailto:ifaisal.eth@gmail.com">ifaisal.eth@gmail.com</a>.
      </p>
